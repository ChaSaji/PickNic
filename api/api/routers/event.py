...
async def list_events():
    return [event_schema.Event(id="1", event_name="イベント1", organizer="主催者1", start_date=datetime(2024, 5, 10), end_date=datetime(2025, 3, 22))]
...
async def update_event(event_id: int, event_body: event_schema.EventUpdate):
    ...
    return event_schema.EventUpdateResponse(**event_data)

@router.delete("/events/{event_id}/delete", response_model=event_schema.EventDeleteResponse)
async def delete_event(event_id: int):
    ...
    return event_schema.EventDeleteResponse(id=event_id, event_name="イベント1", organizer="主催者", start_date="2024-05-10T00:00:00", end_date="2025-03-22T00:00:00", overview="概要の説明", badge_img="ieyasu", target_img="hamamatsu_castle_img", target_name="hamamatsu_castle_name", latitude=12.345, longitude=234.5556)
